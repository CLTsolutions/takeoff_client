...
// import { FlightsState } from './CreateFlights' // importing ts interface state

// type acceptedProps = {
//    token: any
// }
// export class EditFlights extends Component<acceptedProps, FlightsState> {
...
//    editFlight = async (e: React.FormEvent<HTMLFormElement>, id: number): Promise<void> => {
//       e.preventDefault()
//       try { 
...
//                <form className='space-y-3' onSubmit={this.editFlight}>
